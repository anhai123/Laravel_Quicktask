    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{ $user->username }}"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="first-name" class="block mt-1 w-full" type="text" name="first_name"
                    value="{{ $user->first_name }}" disabled autocomplete="first_name" />
            </div>
            <div class="mt-4">
                ...
                <x-text-input id="first-name" class="block mt-1 w-full" type="text" name="last_name"
                    value="{{ $user->last_name }}" disabled autocomplete="last_name" />
            </div>
        </div>
    </div>
</x-app-layout>
